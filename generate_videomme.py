...
import sys
sys.path.append('/root/nfs/codespace/Venus/')
...
if not os.path.exists(file_path):
    os.mkdir(file_path)
data_path = "/root/nfs/download/dataset/lmms-lab/Video-MME" #"/path/to/Video-MME/data"
json_file = f"results/{file_name}.json"

with open("/root/nfs/codespace/Venus/eval/mme_test.json", 'r', encoding='utf-8') as file:
