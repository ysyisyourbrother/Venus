...
def parse_args():
    ...
    """
    parser = argparse.ArgumentParser(description="Evaluate LLaVA-Next-Video with VideoMME settings.")
    parser.add_argument(
        "--video_duration_type",
        required=True,
        type=str,
...
json_file = f"eval/results/eval_llava_next_video_videomme_{args.video_duration_type}_{max_frames_num}.json"
